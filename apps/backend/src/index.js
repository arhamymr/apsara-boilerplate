...
app.use("*", (0, cors_1.cors)({
    origin: function (origin) {
        var _a;
        var allowedOrigins = ((_a = process.env.TRUSTED_ORIGINS) === null || _a === void 0 ? void 0 : _a.split(",")) || [
            "http://localhost:1111",
        ];
...
app.use("*", function (c, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, auth_1.auth.api.getSession({
...
app.on(["GET", "POST"], "/api/auth/**", function (c) {
...
app.get("/api/protected", function (c) {
    var user = c.get("user");
