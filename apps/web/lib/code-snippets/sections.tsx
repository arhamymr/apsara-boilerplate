      ...
      component: (
        <TestimonialsGrid
          ...
          testimonials={[
            {
              content:
                "This component library saved us months of development time. Highly recommended!",
              author: "Sarah Johnson",
              role: "CTO",
              company: "TechCorp",
              rating: 5,
            ...
            {
              content:
                "The best UI kit I've used. Clean code, great documentation, and beautiful designs.",
              author: "Mike Chen",
              role: "Lead Developer",
              company: "StartupXYZ",
              rating: 5,
          ...
          faqs={[
            {
              question: "How do I get started?",
              answer:
                "Simply install the package via npm and follow our quick start guide in the documentation.",
            },
            {
              question: "Can I use this in commercial projects?",
              answer:
                "Yes! Our license allows you to use the components in any personal or commercial projects.",
            },
            {
